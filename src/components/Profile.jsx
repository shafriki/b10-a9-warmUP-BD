...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <div
          className="bg-black/70 w-full h-full absolute top-0 left-0"
          data-aos="fade"
          data-aos-delay="100"
        ></div>
        <div
          className="relative max-w-7xl mx-auto py-16 px-6 text-left"
          data-aos="fade-up"
          data-aos-delay="200"
        >
          ...
          <p className="text-sm md:text-xl text-center font-bold text-green-400">
      ...
      {/* details card */}
      <div className="absolute top-[17rem] left-[50%] transform -translate-x-1/2 bg-white p-8 rounded-lg shadow-xl w-[90%] sm:w-[40rem] text-center">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          ...
          <button
            onClick={logOut} 
            className="btn md:px-10 bg-green-500 border-none text-white"
          >
            Log Out
          </button>
        </div>
